    ...
    public class ColorTextureGeneratorWindow : CustomEditorWindow
    {
        ...
        public GUIStyle CenteredLabelStyle
        {
            get
            {
                ...
                {
                    centeredLabelStyle = Styles.CustomizedButton(DEFAULT_LINE_HEIGHT, TextAnchor.MiddleCenter, new RectOffset(3, 3, 0, 0));
                }
        ...
        public GUIStyle LeftLabelStyle
        {
            get
            {
                ...
                {
                    leftLabelStyle = Styles.CustomizedButton(DEFAULT_LINE_HEIGHT, TextAnchor.MiddleLeft, new RectOffset(5, 5, 0, 0));
                }
        ...
        private GUIStyle centeredLabelStyle = null;
        private GUIStyle leftLabelStyle = null;
        ...
        private void drawObjectsTab()
        {
            ...
            GUIStyle _miniLabelStyle = new GUIStyle(EditorStyles.centeredGreyMiniLabel);
            _miniLabelStyle.padding = new RectOffset(0, 0, 0, 0);
            _miniLabelStyle.margin = new RectOffset(0, 0, 0, 0);

            using (new HorizontalScope())
            {
                GUILayout.Label(string.Empty, _miniLabelStyle, FixedWidth(INDEX_WIDTH));
                GUILayout.Button(NAME, _miniLabelStyle);
                GUILayout.Button(REFERENCE, _miniLabelStyle, FixedWidth(OBJECT_FIELD_WIDTH));
                GUILayout.Label(string.Empty, _miniLabelStyle, FixedWidth(DEFAULT_LINE_HEIGHT));
                GUILayout.Label(string.Empty, _miniLabelStyle, FixedWidth(DEFAULT_LINE_HEIGHT));
            }
            ...
            using (var _scrollView = new ScrollViewScope(foundObjectsScrollPosition))
            {
                ...
                foreach (var _object in sortedAndFilteredColorObjects)
                {
                    ...
                    using (new HorizontalScope())
                    {
                        GUILayout.Label(_index.ToString(), CenteredLabelStyle, FixedWidthAndHeight(INDEX_WIDTH, DEFAULT_LINE_HEIGHT));

                        if (GUILayout.Button(_object.name, LeftLabelStyle, FixedHeight(DEFAULT_LINE_HEIGHT)))
                        {
